...
<!-- header end -->
<form id="Qsearch" method="get">
    <input type="hidden" id="Qkeyword" name="Qkeyword" value="${Qkeyword}"/>
    <input type="hidden" id="Qbrand" name="Qbrand" value="${Qbrand}"/>
    <input type="hidden" id="Qprice" name="Qprice" value="${Qprice}"/>
    <input type="hidden" id="Qsort" name="Qsort" value="${Qsort}"/>
</form>
				...
				<span class="crumbs-arrow">已选条件：</span>
				 <c:forEach items="${map }" var="m">
					<c:forEach items="${m.value }" var="mm">
						<a title="${mm.key }"  href="#" onclick="deleteQuery('${m.key}')" class="crumb-select-item">
							   <b>${mm.key }：</b><em>${mm.value }</em>
							   <i></i>
						</a>
					</c:forEach>
				</c:forEach>
			...
			<div class="sl-v-list">
				...
				<c:forEach items="${brands }" var="brand">
					<li id="brand-38118" data-initial="j" style="display:block;">
						<a href="#" onclick="fqBrand('${brand.id }')" title="${brand.name }"><i></i>${brand.name }</a>
					</li>
				</c:forEach>
				</ul>
			</div>
		...
		<div class="sl-value">
			<div class="sl-v-list">
				<ul class="J_valueList">
					<li>
						<a href="#"  onclick="fqPrice('0-99')"><i></i>0-99</a>
					</li>          
					<li>           
						<a  href="#"  onclick="fqPrice('100-299')"><i></i>100-299</a>
					</li>          
					<li>           
						<a href="#"  onclick="fqPrice('300-599')"><i></i>300-599</a>
					</li>          
					<li>           
						<a  href="#"  onclick="fqPrice('600-999')"><i></i>600-999</a>
					</li>          
					<li>           
						<a  href="#"  onclick="fqPrice('1000-1599')"><i></i>1000-1599</a>
					</li>          
					<li>           
						<a  href="#"  onclick="fqPrice('1600-*')"><i></i>1600以上</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="ml-wrap">
			<div id="J_filter" class="filter">
				<div class="f-line top">
					<div class="f-sort"><a href="javascript:;" class="curr">综合排序<i></i></a><a href="#" class="">销量<i></i></a><a href="#" onclick="qpriceSort()">价格<i></i></a><a href="javascript:;" class="" >评论数<i></i></a><a href="javascript:;" class="">新品<i></i></a></div>
					<div class="f-search">
										...
										<c:forEach items="${pagination.list }" var="product">
											<li data-sku="1711416562" class="gl-item">
												<div class="gl-i-wrap">
													...
													<div class="p-price">
														<strong class="J_1711416562"> <em>￥</em><i>${product.price }</i>
														</strong>
														<div class="p-icons" id="J_pro_1711416562">
															<i class="icons" title="购买本商品送赠品">赠品</i> <i
																class="goods-icons-s1" title="该商品支持货到付款">货到付款</i>
														</div>
													</div>
													...
													<div class="p-commit">
														<strong>已有<a id="J_comment_1711416562"
															target="_blank" href="javascript:;" onclick="">133</a>人评价
														</strong>
													</div>
													<div class="p-operate">
														<a class="p-o-btn contrast J_contrast"
															data-sku="1711416562" href="javascript:;"><i></i>对比</a> <a
															class="p-o-btn focus J_focus" data-sku="1711416562"
															href="javascript:;"><i></i>关注</a> <a
															class="p-o-btn addcart" data-stock-val="1"
															data-disable-notice="0" data-presale="0"
															href="javascript:;" data-parallel="0"><i></i>加入购物车</a>
													</div>
												</div>
											</li>
										</c:forEach>
