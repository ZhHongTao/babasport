...
<div id="top">
     <div class="top">
          ...
          <tr>
            <td width="215"><div class="logo"><img src="/images/admin/logo.jpg" width="215" height="69" /></div></td>
            <td valign="top">
                <div class="topbg">
                     <div class="login-welcome">
                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <img src="/images/admin/welconlogin-icon.png"/><span id="welcome">您好:admin!</span>
                                    <img src="/images/admin/loginout-icon.png"/><a href="logout.do?returnUrl=index.do" target="_top" id="logout" onclick="return confirm('您确定退出吗?');">退出</a> 
                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);"><a href="frame/ad_main.do" target="mainFrame">广告</a></li>
										...
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);"><a href="frame/product_main.jsp" target="mainFrame">维护</a></li>
										<li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(19);"><a href="frame/product_main.jsp" target="mainFrame">生成</a></li>
										<li class="sep"></li><li class="normal" id="tb_20" onclick="HoverLi(20);"><a href="frame/product_main.jsp" target="mainFrame">用户</a></li>
										<li class="sep"></li><li class="normal" id="tb_21" onclick="HoverLi(21);"><a href="frame/product_main.jsp" target="mainFrame">配置</a></li>
                                    </ul>
                                </td>
                              </tr>
                            </table>
