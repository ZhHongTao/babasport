...
<%@ include file="../date.jsp" %>
     <ul class="w-lful">
		...
		<li><a href="type/list.do" target="rightFrame">商品参数</a></li>
		<li><a href="type/list.do" target="rightFrame">规格管理</a></li>
		<li><a href="type/list.do" target="rightFrame">商品属性</a></li>
		<li><a href="type/list.do" target="rightFrame">到货通知</a></li>
     </ul>
</div>
</body>
</html>